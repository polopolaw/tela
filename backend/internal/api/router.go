...
func registerRoutes(srv *Server, mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/spaces/{id}/suggestions", srv.ListSpaceSuggestions)
	...
	mux.HandleFunc("POST /api/pages/{id}/suggestions", srv.CreatePageSuggestion)
	mux.HandleFunc("GET /api/pages/{id}/suggestions", srv.ListPageSuggestions)
	mux.HandleFunc("GET /api/suggestions/{id}", srv.GetPageSuggestion)
	mux.HandleFunc("GET /api/suggestions/{id}/hunks", srv.GetSuggestionHunks)
	mux.HandleFunc("POST /api/suggestions/{id}/apply", srv.ApplyPageSuggestion)
	mux.HandleFunc("POST /api/suggestions/{id}/reject", srv.RejectPageSuggestion)
	mux.HandleFunc("POST /api/suggestions/{id}/withdraw", srv.WithdrawPageSuggestion)
